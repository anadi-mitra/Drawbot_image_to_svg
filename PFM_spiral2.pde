class PFM_spiral2 implements pfm {
  ...
  public void find_path() {
    ...
    float dist = 2+random(0, 5);                            // Distance between rings
    float radius = dist/2.0;                     // Current radius
    ...
    float density = 100+random(0,50);                        // Density
    float ampScale = 0.98*dist/2.0;                      // Controls the amplitude
